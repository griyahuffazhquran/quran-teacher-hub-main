import{r as e}from"./rolldown-runtime-hePW80VL.js";import{a as t,h as n,m as r,r as i}from"./button-CFHvP6kr.js";import{$ as a,At as o,Dt as s,Et as c,G as l,J as u,Mt as d,Ot as f,jt as p,kt as m,qt as h,tt as g}from"./card-4qXk11N_.js";function _(e,t,n){let r=new Blob([e],{type:n}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=t,document.body.appendChild(a),a.click(),document.body.removeChild(a),URL.revokeObjectURL(i)}function v(e){return e==null?`""`:`"${String(e).replace(/"/g,`""`)}"`}function y(e){_(`﻿`+[[`ID`,`Nama Guru`,`Username`,`Gender`,`Role`,`Jabatan`,`Spesialisasi`,`Level Target`,`No HP`,`Status`,`Tanggal Bergabung`,`Created At`,`Updated At`].join(`,`),...e.map(e=>[v(e.id),v(e.name),v(e.username||``),v(e.gender),v(e.role||`teacher`),v(e.position||``),v(e.specialization||``),v(e.level),v(e.phone||``),v(e.status),v(e.joinedAt),v(e.createdAt),v(e.updatedAt)].join(`,`))].join(`
